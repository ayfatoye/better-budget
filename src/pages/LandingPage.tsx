...
function LandingPage() {
    ...
    return (
        <div style={{backgroundColor: "#C8A3D8"}} className="w-screen h-screen flex justify-center items-center">
            <div style={{backgroundColor: "#EAD9D9"}} className="rounded-2xl w-[90vw] h-[40vh] md:w-[40vw] md:h-[40vh] xl:w-[30vw] xl:h-[40vh] ">
                ...
                <div className="mt-3">
                    ...
                    <div className="flex flex-col justify-center items-center">
                        <div className="w-full">
                            ...
                            <button type="button" style={{backgroundColor: "#7E4E92"}} className="font-poppins mt-5 w-[75%]">Log In/Sign Up</button>
